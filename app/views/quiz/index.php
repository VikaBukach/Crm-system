...
<div class="accordion quiz" id="quizes-accordion">
<?php foreach ($quizes as $quiz): ?>
 <div class="accordion-item mb-2">
            ...
            <div id="quiz-collapse-<?php echo $quiz['id']; ?>" class="accordion-collapse collapse row" aria-labelledby="quiz-<?php echo $quiz['id']; ?>" data-bs-parent="#quizs-accordion">
